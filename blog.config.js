...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '18674ae4c51f8096b1a1fda935f1b667',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'ja-JP.js', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'パワーポイント テンプレート SHOP', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'パワーポイント テンプレート マーケット', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.powerpoint-template.shop/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'パワーポイント, テンプレート,マーケット', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '翻訳者・デザイナー・フォトグラファーとしてスキルを活かして活動中。',
